...
void loop() {
 ...
 float three = pow(0.1, 3); 
 float five = pow(0.1, 5); 
 float seven = pow(0.1, 7); 
 float nine = pow(0.1, 9); 
 float fourteen = pow(0.1, 14); 
 float Vobj = tmp[0] * 1.5625 * seven;
 float Tdie = tmp[1] * 0.03125 + 273.15;
 float S;
 float S0 = 7 * fourteen;
 float a1 = 1.75 * three;
 float a2 = -1.678 * five;
 ...
 Tobj = Tdie*Tdie*Tdie*Tdie + ((Vobj - Vos) + c2*(Vobj - Vos)*(Vobj - Vos))/S;
 Tobj = pow(Tobj, 0.5);
 Tobj = pow(Tobj, 0.5);
 Tobj = Tobj - 273.15;
 
 Serial.println("Temperature");
 Serial.println(Tobj, 5);
